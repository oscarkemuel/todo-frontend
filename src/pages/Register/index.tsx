        ...
        <form className="user-data-form-register">
            <div className="controls">
                ...
                <div className="control">
                    ...
                    <input type="text" id="surnames" name="surnames" placeholder="Write your surname"
                           maxLength={64} minLength={1} required />
                </div>
                ...
                <div className="control">
                    ...
                    <input type="date" id="birthdate" name="birthdate" placeholder="Write your birth date" />
                </div>
                ...
                <div className="control">
                    <label>Phone</label>
                    <input type="tel" id="phone" name="phone" placeholder="Write your telephone"
                ...
                <div className="control">
                    <label>Password</label>
                    <input type="password" placeholder="Confirm your pasword" id="confirm_password"
                           name="confirm_password" maxLength={20} minLength={5} required />
                </div>
